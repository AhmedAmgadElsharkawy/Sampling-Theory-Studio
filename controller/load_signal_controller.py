...
class SignalItem(QWidget):
    ...
    def show_signal(self):
        ...
        self.main.sampling_controller.change_sampling_freq_and_plot_all_signals(1)
        self.main.sampling_freq_slider.setEnabled(True)
        self.main.sampling_freq_slider.setRange(2, int(math.ceil(4 * self.main.displayed_signal.max_frequency)))
        self.main.sampling_freq_slider.setValue(2)
